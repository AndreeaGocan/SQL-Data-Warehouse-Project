...
| gender          |NVARCHAR(50)   | The gender of the customer (eg. 'Female', 'Male', 'n/a').                             |
| birthdate       |DATE           | The date of birth of the customer, formated as 'YYYY-MM-DD' (eg. 1971-10-06).         |
...
| Column Name    | Data Type      |                                        Description                                                  |
|----------------|----------------|-----------------------------------------------------------------------------------------------------|
| product_key    |INT             | Surrogate key unequely identifying each product record in the product dimension table.              |
...
| category       |NVARCHAR(50)    | The broader classification of the product (eg. Bikes, Components) to group related items.           |
